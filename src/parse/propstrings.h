...
enum {
	...
	/* facebook css layout support :PROPERTIES */
	FLEX_DIRECTION, JUSTIFY_CONTENT, ALIGN_CONTENT, ALIGN_ITEMS, ALIGN_SELF,
	FLEX_WRAP, FLEX_GROW, FLEX_SHRINK, FLEX_BASIS, FLEX,

	/* css3 support :PROPERTIES */
	...
	/* facebook css layout support :ATTRIBUTES */
	ROW, ROW_REVERSE, COLUMN_REVERSE, FLEX_START, FLEX_END, SPACE_BETWEEN,
	SPACE_AROUND, STRETCH, WRAP_KEYWORD, WRAP_REVERSE,
  ...
  /* css3 support */
  IMAGE, LINEAR_GRADIENT, RADIAL_GRADIENT, REPEATING_LINEAR_GRADIENT,
  REPEATING_RADIAL_GRADIENT,TO,
