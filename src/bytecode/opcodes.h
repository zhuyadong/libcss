...
enum op_image {
	IMAGE_NONE = 0x0000,
  IMAGE_URI = 0x0001,
  IMAGE_LINEAR_GRADIENT = 0x0002,
  IMAGE_REPEATING_LINEAR_GRADIENT = 0x0003,
  IMAGE_RADIAL_GRADIENT = 0x0004,
  IMAGE_REPEATING_RADIAL_GRADIENT = 0x0005
};

enum op_background_image {
  BACKGROUND_IMAGE_NONE = IMAGE_NONE,
  BACKGROUND_IMAGE_URI = IMAGE_URI,
  BACKGROUND_IMAGE_LINEAR_GRADIENT = IMAGE_LINEAR_GRADIENT,
  BACKGROUND_IMAGE_REPEATING_LINEAR_GRADIENT = IMAGE_REPEATING_LINEAR_GRADIENT,
  BACKGROUND_IMAGE_RADIAL_GRADIENT = IMAGE_RADIAL_GRADIENT,
  BACKGROUND_IMAGE_REPEATING_RADIAL_GRADIENT = BACKGROUND_IMAGE_RADIAL_GRADIENT
};
