...
{
  return css__cascade_length(opv, style, state, set_border_bottom_right_radius);
}
...
{
  return set_border_bottom_right_radius(state->computed, CSS_BORDER_RADIUS_SET, 0, CSS_UNIT_PX);
}
