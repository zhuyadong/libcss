...
enum css_flex_direction_e {
	...
	CSS_FLEX_DIRECTION_COLUMN           = 0x1,
	CSS_FLEX_DIRECTION_COLUMN_REVERSE   = 0x2,
	CSS_FLEX_DIRECTION_ROW              = 0x3,
	CSS_FLEX_DIRECTION_ROW_REVERSE      = 0x4,
};

enum css_justify_content_e {
	CSS_JUSTIFY_CONTENT_INHERIT         = 0x0,
	CSS_JUSTIFY_CONTENT_FLEX_START      = 0x1,
	CSS_JUSTIFY_CONTENT_CENTER          = 0x2,
	CSS_JUSTIFY_CONTENT_FLEX_END        = 0x3,
	CSS_JUSTIFY_CONTENT_SPACE_BETWEEN   = 0x4,
	CSS_JUSTIFY_CONTENT_SPACE_AROUND    = 0x5,
};

enum css_align_type_e {
	CSS_ALIGN_TYPE_INHERIT              = 0x0,
	CSS_ALIGN_TYPE_AUTO                 = 0x1,
	CSS_ALIGN_TYPE_FLEX_START           = 0x2,
	CSS_ALIGN_TYPE_CENTER               = 0x3,
	CSS_ALIGN_TYPE_FLEX_END             = 0x4,
	CSS_ALIGN_TYPE_STRETCH              = 0x5,
...
enum css_align_items_e {
	CSS_ALIGN_ITEMS_INHERIT     = CSS_ALIGN_TYPE_INHERIT,
	CSS_ALIGN_ITEMS_FLEX_START  = CSS_ALIGN_TYPE_FLEX_START,
	CSS_ALIGN_ITEMS_CENTER      = CSS_ALIGN_TYPE_CENTER,
	CSS_ALIGN_ITEMS_FLEX_END    = CSS_ALIGN_TYPE_FLEX_END,
	CSS_ALIGN_ITEMS_STRETCH     = CSS_ALIGN_TYPE_STRETCH,
	CSS_ALIGN_ITEMS_BASELINE    = CSS_ALIGN_TYPE_BASELINE,
};

enum css_align_self_e {
	CSS_ALIGN_SELF_INHERIT      = CSS_ALIGN_TYPE_INHERIT,
	CSS_ALIGN_SELF_AUTO         = CSS_ALIGN_TYPE_AUTO,
	CSS_ALIGN_SELF_FLEX_START   = CSS_ALIGN_TYPE_FLEX_START,
	CSS_ALIGN_SELF_CENTER       = CSS_ALIGN_TYPE_CENTER,
	CSS_ALIGN_SELF_FLEX_END     = CSS_ALIGN_TYPE_FLEX_END,
	CSS_ALIGN_SELF_STRETCH      = CSS_ALIGN_TYPE_STRETCH,
	CSS_ALIGN_SELF_BASELINE     = CSS_ALIGN_TYPE_BASELINE,
};
